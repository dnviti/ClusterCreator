...
playbooks=(
  ...
  "playbooks/cluster-management/upgrade-source-packages.yaml"
  "playbooks/cluster-management/upgrade-k8s-packages.yaml"
  "playbooks/setup-and-config/etcd-encryption.yaml"
  "playbooks/cluster-management/upgrade-apt.yaml"
)
